            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-foreground-muted mt-1">
                  Upgrade to Pro and save <span className="text-yellow-400 font-semibold">{offer.subscription_discount_pct}%</span> on your first month.
                  Get instant engagement without completing tasks.
                </p>
